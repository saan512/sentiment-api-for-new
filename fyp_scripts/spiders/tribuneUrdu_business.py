...
class TribuneurduBusinessSpider(scrapy.Spider):
    name = 'tribuneUrdu_business'
    allowed_domains = ['www.express.pk']
    start_urls = ['https://www.express.pk/business']
    ...
    custom_settings = {
       'DOWNLOAD_DELAY': 0.8,
        'FEEDS': {'tribuneUrdu_business.csv': {'format': 'csv'}}
    }
